        ...
        <div className="w-screen min-h-screen mb-5 bg-[#f3f4f6] p-4">
            <div className="flex justify-between items center py-4 border-b border-neutral-300 px-4">
                ...
                <div className='flex items-center gap-x-3'>
                    ...
                    <button className="mr-3 flex items-center px-2 py-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out" title="Clear entries">
                        <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="icon">
                            <path fill-rule="evenodd" d="M8.75 1A2.75 2.75 0 006 3.75v.443c-.795.077-1.584.176-2.365.298a.75.75 0 10.23 1.482l.149-.022.841 10.518A2.75 2.75 0 007.596 19h4.807a2.75 2.75 0 002.742-2.53l.841-10.52.149.023a.75.75 0 00.23-1.482A41.03 41.03 0 0014 4.193V3.75A2.75 2.75 0 0011.25 1h-2.5zM10 4c.84 0 1.673.025 2.5.075V3.75c0-.69-.56-1.25-1.25-1.25h-2.5c-.69 0-1.25.56-1.25 1.25v.325C8.327 4.025 9.16 4 10 4zM8.58 7.72a.75.75 0 00-1.5.06l.3 7.5a.75.75 0 101.5-.06l-.3-7.5zm4.34.06a.75.75 0 10-1.5-.06l-.3 7.5a.75.75 0 101.5.06l.3-7.5z" clip-rule="evenodd" />
                        </svg>
                    </button>

                    <button className="mr-3 flex items-center px-2 py-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out" title="Auto load entries">
                        <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="icon">
                            <path fill-rule="evenodd" d="M15.312 11.424a5.5 5.5 0 01-9.201 2.466l-.312-.311h2.433a.75.75 0 000-1.5H3.989a.75.75 0 00-.75.75v4.242a.75.75 0 001.5 0v-2.43l.31.31a7 7 0 0011.712-3.138.75.75 0 00-1.449-.39zm1.23-3.723a.75.75 0 00.219-.53V2.929a.75.75 0 00-1.5 0V5.36l-.31-.31A7 7 0 003.239 8.188a.75.75 0 101.448.389A5.5 5.5 0 0113.89 6.11l.311.31h-2.432a.75.75 0 000 1.5h4.243a.75.75 0 00.53-.219z" clip-rule="evenodd" />
                        </svg>
                    </button>

                    <Link to="/monitored-tags" className="flex items-center px-2 py-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out" title="Monitoring">
                        <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" className="icon" >
                ...
                <div className="col-span-2 px-4">
                    <ul className="nav flex-column">
                        <li className="nav-item">
                            <Link to="/requests" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/commands" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/schedule" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/jobs" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item mt-3">
                            <Link to="/batches" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/cache" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/dumps" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/events" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/exceptions" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/gates" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/client-requests" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/logs" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/mail" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/models" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/notifications" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/queries" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/redis" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                        ...
                        <li className="nav-item">
                            <Link to="/views" className="px-3 py-2 rounded-md flex items-center gap-x-2 hover:bg-[#e5e7eb] transition-bg duration-300 ease-in-out">
                                <svg width="20" height="20" fill="#888f98" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
